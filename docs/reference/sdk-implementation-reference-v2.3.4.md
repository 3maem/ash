...
MAX_NONCE_LENGTH          = 128       // SEC-NONCE-001: Maximum nonce length
...
2. Length <= MAX_NONCE_LENGTH (128)
   Error: "Nonce exceeds maximum length of 128 characters"
...
[ ] Nonce maximum length (128 chars)
...
3. **Add nonce max length validation**: Reject > 128 chars
