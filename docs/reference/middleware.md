...
|-----------|-----|---------|
| Express | Node.js | `@3maem/ash-node` |
| Fastify | Node.js | `@3maem/ash-node` |
| Flask | Python | `ash-sdk[flask]` |
| FastAPI | Python | `ash-sdk[fastapi]` |
| Django | Python | `ash-sdk[all]` |
| Gin | Go | `github.com/3maem/ash-go/v2` |
| Laravel | PHP | `3maem/ash-sdk-php` |
| CodeIgniter | PHP | `3maem/ash-sdk-php` |
| WordPress | PHP | `3maem/ash-sdk-php` |
| Drupal | PHP | `3maem/ash-sdk-php` |
...
```javascript
import { ashFastifyPlugin, AshMemoryStore } from '@3maem/ash-node';
