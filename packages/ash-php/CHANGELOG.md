...
All notable changes to the ASH PHP SDK will be documented in this file.
...
- IP and user binding enforcement in Laravel/CodeIgniter/WordPress/Drupal middleware
- Unique HTTP status codes (450-483 range)
- Scope policies in WordPress middleware
...
### Fixed
- Scope sorting to use byte-wise sorting
- Missing query string in middleware binding normalization
...
### Added
- Initial v2 release
- Laravel, CodeIgniter, WordPress, and Drupal middleware
